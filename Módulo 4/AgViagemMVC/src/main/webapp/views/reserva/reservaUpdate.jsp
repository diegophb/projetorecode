...
<title>Alteração de Reserva ${reserva.cliente.nome}</title>
...
<body>
 <header>
	...
	<div class="container">
		<h5>Alteração da Reserva ${reserva.cliente.nome}</h5>
		<form action="alterarre" method="post" class="form-control"> 
			...
			<fieldset>
               ...
               <input type="hidden" name="id" value="${reserva.id}">
                ...
                <p>
					...
					<option value="DAFAULT">${reserva.destino.nome} </option>
				...
				<option value="${destino.id}">${destino.nome}</option>
					...
					<option value="DAFAULT">${reserva.pacote.nome}  </option>
				...
				<p>
					<label for="data">Data da reserva:</label> <input type="text"
