...
<div class="container">
		...
		<form action="InserirDestino" method="post" class="form-control">
			<fieldset>
				<legend>Dados Destino</legend>
...
<thead>
  ...
  <a href="destino-delete?id=${destino.id}" onclick="return confirm('Deseja Excluir? ${destino.nome}.')"
